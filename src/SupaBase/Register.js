...
export default function Register() {
  ...
  const handleRegister = async (e) => {
    e.preventDefault();
    setErrors({ nombre: "", email: "", password: "", submit: "" });
      ...
      <div className="w-full max-w-md">
        ...
        <div className="rounded-xl border bg-card text-card-foreground shadow border-2 border-gray-200 shadow-xl">
          <div className="flex flex-col space-y-1.5 p-6">
            <h2 className="font-bold text-2xl text-center">Crear Usuario</h2>
            <p className="text-sm text-muted-foreground text-center">
              Crea tu usuario y espera a que tu docente te asigne el curso
            </p>
          </div>
