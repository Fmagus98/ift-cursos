...
import PythonClass6Content1 from "./PythonClass6Content1";
import PythonClass6Content2 from "./PythonClass6Content2";
import PythonClass6Content3 from "./PythonClass6Content3";
import PythonClass6Content4 from "./PythonClass6Content4";
import PythonClass6Content5 from "./PythonClass6Content5";
import PythonClass6Content6 from "./PythonClass6Content6";
import PythonClass6Content7 from "./PythonClass6Content7";
      ...
      <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
        <section className="relative py-12 px-4 bg-gradient-to-br from-cyan-600 to-cyan-700">
          <div className="container mx-auto">
              <button onClick={() => navigate("/course/a586408c-e2d5-4a43-8356-cdb9aa9b8091")} className="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 hover:text-accent-foreground h-9 px-4 py-2 mb-6 text-white hover:bg-white/20">
                <svg
