  ...
  `}
            ...
            <div className="flex-1">
              <div className="flex items-center gap-2 flex-wrap">
                <h4 className="font-semibold text-gray-900">3. Bucles</h4>
                {done && (
                  <span
        ...
        <Accordion.Content className=" border-t border-gray-200 bg-gray-50 p-6 space-y-6 text-sm text-gray-700 data-[state=open]:animate-accordion-down data-[state=closed]:animate-accordion-up">
          <section>
            ...
            <p className="leading-relaxed mt-4 mb-6">
              En programación,{" "}
              <strong>
                los bucles son estructuras que nos permiten repetir un bloque de
                código varias veces.
              </strong>
              <br></br>Estos bloques se ejecutan hasta que se cumple una
              condición específica.
            </p>

            <p className="leading-relaxed mb-6">
              Los bucles son especialmente útiles cuando queremos automatizar
              tareas repetitivas o procesar colecciones de elementos. <br></br>
              En lugar de escribir líneas individuales para cada repetición,{" "}
              <strong>
                podemos utilizar bucles para hacerlo de manera más eficiente y
                concisa.
              </strong>
            </p>
