...
import PythonClass7Content1 from "./PythonClass7Content1";
import PythonClass7Content2 from "./PythonClass7Content2";
import PythonClass7Content3 from "./PythonClass7Content3";
import PythonClass7Content4 from "./PythonClass7Content4";
    ...
    <div>
      <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
        ...
        <div className="md:mx-40 mx-4 mb-10 flex justify-between items-center gap-4">
          ...
          <Link
            to="/python/jha93g208ag7kcgekglkqxnh52inhuh5m32wk"
            className="inline-block"
          >
            <button className="inline-flex items-center justify-center gap-2 font-medium text-lg px-4 py-6 h-10 rounded-md bg-cyan-600 text-white hover:bg-cyan-700 transition-colors">
              Clase Siguiente
