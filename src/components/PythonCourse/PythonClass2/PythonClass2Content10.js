...
import { questionsPythonClass2 } from "../../QuizForm/questionsPython";

const PythonClass2Content10 = ({ onComplete, completed }) => {
  const done = completed?.includes(10);
  ...
  `}
            ...
            <div className="flex-1">
              <div className="flex items-center gap-2 flex-wrap">
                <h4 className="font-semibold text-gray-900">
                  10. Evaluación de Conocimientos: Clase 2 - Variables en Python
                </h4>
                {done && (
                  <span
        ...
        <Accordion.Content forceMount  className="
    px-5 pt-2 overflow-hidden
...
export default PythonClass2Content10;
