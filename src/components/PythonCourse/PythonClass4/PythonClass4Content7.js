...
import { questionsPythonClass4 } from "../../QuizForm/questionsPython";

const PythonClass4Content7 = ({ onComplete }) => {
      ...
      >
            ...
            <div className="flex-1">
              <div className="flex items-center gap-2 flex-wrap">
                <h4 className="font-semibold text-gray-900">
                  7. Evaluación de Conocimientos: Clase 4 - Funciones y módulos
                </h4>
                {done && (
                  <span
        ...
        >
          <section>
            ...
            <QuizForm
              questions={questionsPythonClass4}
              onDone={() => {
                setDone(true);
                onComplete("class4content7");
              }}
            />
          </section>
        </Accordion.Content>
...
export default PythonClass4Content7;
